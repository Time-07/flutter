...
class SearchDataSource extends ISearchDatasource{
  ...
  @override
  Future<List<MedicoModel>> search(String gender, String speciality, String city) async{
  ...
  lista.add(MedicoModel(name: "", email: "", password: "", cpf: "", gender: "", cellPhone: 0, street: "", number: 1, neighborhood: "", city: "", state: "", crmCrp: "", specialty: "", phone: 0, value: 0, description: "", courses: "", healthPlan: "", bathroomSpecific: true, linkedin: ""));
  return lista;
  }
