...
class SearchRepository extends ISearchRepository{
  ...
  SearchRepository({required ISearchDatasource searchDatasource}):_SearchDatasource = searchDatasource;

  @override
  Future<List<MedicoEntity>> search(String gender, String speciality, String city) async {
    final result = await _SearchDatasource.search(gender, speciality, city);

    List<MedicoEntity> lista = [];
  lista.add(MedicoEntity(name: "", email: "", password: "", cpf: "", gender: "", cellPhone: 0, street: "", number: 1, neighborhood: "", city: "", state: "", crmCrp: "", specialty: "", phone: 0, value: 0, description: "", courses: "", healthPlan: "", bathroomSpecific: true, linkedin: ""));
  return lista;
    //return result;
  }
}